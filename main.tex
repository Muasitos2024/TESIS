...
\titleformat{\section}
  {\normalfont\bfseries\fontsize{12pt}{14pt}\selectfont} % Ajusta el tamaño
  {\thesection.}{1em}{}
...
\usepackage{textcomp}
\usepackage{verbatim}
\usepackage{parskip} % Para controlar el espaciado entre párrafos
...
\includepdf[pages=1]{repositorio.pdf}
